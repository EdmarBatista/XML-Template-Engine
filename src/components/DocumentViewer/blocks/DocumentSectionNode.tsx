...
export function renderDocumentSectionNode(
  ...
  const reiniciar = node.atributos?.reiniciar === 'true';
  ...
  const safeNivelSecao = nivelSecao || 1;
  const proximoNivel = numerarFilhos ? safeNivelSecao + 1 : safeNivelSecao;
