  ...
  return (
    <div>
      <input
        ...
        className="w-full text-xs text-slate-900 bg-slate-50 border border-slate-300 rounded-md px-2.5 py-1.5 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
      />
    </div>
  );
};
