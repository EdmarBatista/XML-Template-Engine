...
export const DEFAULT_TEMPLATES: TemplateItem[] = [
  {
    ...
    <formulario>
        <grupo titulo="1. Identificação da Contratação">
            ...
            <input id="cnpj" label="CNPJ da Contratada" tipo="cnpj" descricao="CNPJ para demonstração de formatação"/>
            <input id="cep" label="CEP da Unidade" tipo="cep" descricao="CEP para demonstração de formatação"/>
        </grupo>
        ...
        <grupo titulo="2. Objeto">
            ...
            <radio id="divisao_objeto" label="Nota Explicativa sobre o Objeto">
                ...
                <if expr="divisao_objeto == 'varios'">
                    <number id="quantidade_itens" label="Informe a quantidade de itens" min="1" step="1" tipo="numero_inteiro"/>
                </if>
        ...
        <grupo titulo="4. Prazo e Vigência">
            <number id="prazo_execucao_dias" label="Prazo de Execução (dias)" min="1" step="1" tipo="numero_inteiro" descricao="Prazo de execução em dias"/>
        ...
        <grupo titulo="7. Itens e Serviços">
            ...
            <number id="quantidade_total" label="Quantidade total de itens" min="1" step="1" tipo="numero_inteiro" descricao="Quantidade total de itens"/>
    ...
    <formulario>
        ...
        <grupo titulo="3. Escopo e Preço">
            ...
            <select id="forma_pagamento" label="Forma de Pagamento" descricao="Condição de quitação">
                ...
                <option>Parcelado em parcelas mensais</option>
